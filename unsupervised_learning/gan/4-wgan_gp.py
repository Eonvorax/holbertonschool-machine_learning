#!/usr/bin/env python3
"""
Pre-trained Wasserstein GAN with Gradient Penalty
"""
...
class WGAN_GP(keras.Model):
    ...
    def replace_weights(self, gen_h5, disc_h5):
        """
        Replace the weights of the generator and discriminator with
        the weights stored in corresponding local files.
        """
