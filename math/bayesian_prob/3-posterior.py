...
def marginal(x, n, P, Pr):
    ...
    - P (numpy.ndarray): 1D numpy.ndarray containing the various hypothetical
    ...
    """
    # NOTE Required validation is the same as intersection method
    intersection_values = intersection(x, n, P, Pr)

    # Marginal prob. of observed data: the sum of all intersection values
...
def posterior(x, n, P, Pr):
    ...
    Returns:
    - numpy.ndarray: 1D numpy.ndarray containing the posterior probability
    of each probability in P given x and n, respectively.
    """
    # NOTE Required validation is the same as marginal() method
